...
function build_lib {
	...
	cd device && \
	gcc $1 -c max31850.c -D_REENTRANT $DEBUG_PARAM -pthread && \
	cd ../ && \
	cd acp && \
	...
	rm -f libpac.a
	ar -crv libpac.a app.o crc.o gpio.o timef.o $SOCK.o util.o tsv.o lcorrection.o 1w.o device/max31850.o acp/main.o && echo "library: done" && echo "hardware: $CPU $PINOUT"
	rm -f *.o acp/*.o
}
function build {
	cd lib && \
